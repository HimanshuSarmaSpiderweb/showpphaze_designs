...
const ContainerConfidentiality = () => {
  const heading = "26. CONFIDENTIALITY";
  const textContent = (
    <>
      <Typography variant="body1" sx={{ mb: 2 }}>
...
const ContainerMiscellaneous = () => {
  const heading = "30. MISCELLANEOUS";
  const textContent = (
    <>
      <Typography variant="h6" sx={{ fontWeight: 'bold', mb: 1 }}>
...
const ContainerTimeAndAHalf = () => {
  const heading = "4. TIME AND A HALF & INCREASED RATES.";
  const textContent = (
    <>
      <Typography variant="body1" sx={{ mb: 2 }}>
        Services provided by each Company personnel outside of California will be billed to Client according to the following:
      ...
      <Typography variant="body1" sx={{ mb: 2 }}>
         Regular Hourly Rate applies for hours worked between 6:00 am and 12:00 am. A rate of one and half (1.5x) of the Regular Hourly Rate will be charged for all additional hours worked between 8 and 10 hours and for all hours worked between 12:00 am and 6:00 am. A rate of double-time (2x) of the Regular Hourly Rate will apply for all hours worked past ten (10) hours. If a personnel is already in overtime because they have worked more than ten (10) hours and they are also working between 12:00 am and 6:00 am then the rate will be increased to the double time rate (2x). If overtime is being charged for a federal holiday (see below), and the personnel works past eight (8) hours, then the overtime rate will be increased to double time (2x). If more than two overtime or meal penalties (as defined below) have been incurred, then any additional penalties will be increased in .5 increments (by way of example, double time (2x) goes to 2.5x, then to triple time (3x), and so on).
      </Typography>
      ...
      <Typography variant="body1" sx={{ mb: 2 }}>
        All five (5) hour calls for lead positions will be billed for a full ten (10) hour call.
        <br />
        For install positions, all five (3) hour calls will be at the Regular Hourly Rate (as defined below) with a fee of Five U.S. dollars ($5) per position.
      </Typography>
    </>
  );
...
const IntegrationServiceAgreement = () => {
  ...
  return (
    <>
      ...
      >
        ...
        <Container
          heading={"27. NON-SOLICITATION & NON-DISPARAGEMENT."}
          showHeading={true}
          textContent={text28}
        />

        <Container
          heading={"28. DISPUTE RESOLUTION."}
          showHeading={true}
          textContent={text29}
        />
...
export default IntegrationServiceAgreement;