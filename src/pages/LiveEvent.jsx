...
import LiveEventRateCard from './LiveEventRateCard';
import LiveEventServiceAgreement from './LiveEventServiceAgreement';
import LiveEventRateSheet from '../pages/LiveEventRateSheet';
    ...
    >
      ...
      >
        <ParentComponent
          tabs={{
            0: <LiveEventRateCard />,
            1: <LiveEventRateSheet />,
            2: <LiveEventServiceAgreement />
          }}  
          tabLabels={[
            "Live Event Rate Card",
            "Live Event Rate Sheet",
            "Live Event Service Agreement",
          ]}
